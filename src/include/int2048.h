...
// todo
    ...
    public:
        ...
        int2048 plain_mul(const int2048 &Num, long long Mul, int BASE){  //0 <= Mul < base Mul*(base^BASE)
            if (Mul == 0) {
                int2048 Self(0);
                return Self;
            }
